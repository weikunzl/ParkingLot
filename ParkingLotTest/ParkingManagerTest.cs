...
namespace ParkingLotTest
{
    ...
    public class ParkingManagerTest
    {
        ...
        public void Should_return_a_parking_ticket_number_when_parking_given_a_car()
        {
            ...
            SequenceParkingManager sequenceParkingManager = new SequenceParkingManager(parkingLots);

            string ticketNumber = sequenceParkingManager.Parking(new Car("AE00003"));
        ...
        public void Should_return_2_parking_ticket_number_when_parking_given_2_car()
        {
            ...
            List<string> ticketNumbers = sequenceParkingManager.Parking(cars);
        ...
        public void Should_parking_sequentially_to_other_parking_lot_when_parking_given_2_parkingLots()
        {
            ...
            SequenceParkingManager sequenceParkingManager = new SequenceParkingManager(parkingLots);
            List<string> ticketNumbers = sequenceParkingManager.Parking(new List<Car>
            {
                new Car("AE00001"),
                new Car("AE00002"),
            });
        ...
        public void Should_pickup_a_parked_car_when_pickup_at_parking_lot_given_a_ticket()
        {
            ...
            SequenceParkingManager sequenceParkingManager = new SequenceParkingManager(parkingLots);
            var ticketNumber = sequenceParkingManager.Parking(new Car("AE8888"));

            Car car = sequenceParkingManager.Pickup(ticketNumber);
        ...
        {
            SequenceParkingManager sequenceParkingManager = new SequenceParkingManager(new List<ParkingLot>()
            {
                new ParkingLot(2),
                new ParkingLot(10),
            });
            sequenceParkingManager.Parking(new Car("AE8888"));

            Action parkingAction = () => sequenceParkingManager.Parking(new Car("AE8888"));
        ...
        public void Should_throw_WrongTicketException_when_parking_given_a_wrong_ticket()
        {
            ...
            Action pickupAction = () => sequenceParkingManager.Pickup("T11111");
        ...
        public void Should_throw_WrongTicketException_when_parking_given_a_ticket_has_been_used()
        {
            ...
            var ticket = sequenceParkingManager.Parking(new Car("AE8888"));
            Car car = sequenceParkingManager.Pickup(ticket);

            Action pickupAction = () => sequenceParkingManager.Pickup(ticket);
        ...
        public void Should_throw_TicketNoProvideException_when_parking_given_NO_ticket()
        {
            ...
            Action pickupAction = () => sequenceParkingManager.Pickup(null);
        ...
        public void Should_throw_NotEnoughCapacityException_when_parking_given_parking_lot_capacity_2()
        {
            ...
            var ticketNumbers = sequenceParkingManager.Parking(cars);

            Action parkingAction = () => sequenceParkingManager.Parking(new Car("AE00003"));
